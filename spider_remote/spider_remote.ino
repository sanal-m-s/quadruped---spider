...
void setup()
{
  ...
  Wire.begin();
  pwm.begin();
  pwm.setPWMFreq(50);  // Standard 50Hz servo frequency
  delay(10);
...
void polar_to_servo(int leg, float alpha, float beta, float gamma) {
  ...
  // Write to PCA9685
  int channel0 = servo_channel[leg][0];
  int channel1 = servo_channel[leg][1];
  int channel2 = servo_channel[leg][2];

  pwm.setPWM(channel0, 0, angleToPulse(alpha));
  pwm.setPWM(channel1, 0, angleToPulse(beta));
  pwm.setPWM(channel2, 0, angleToPulse(gamma));
}